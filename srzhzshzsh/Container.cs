...
namespace GarpPractice
{
    class Container
    {
        public void takeContainer(string title)
        {
        ...
        public async Task<string> getContainer(bool demo, int page, int page_size, string titletitle__icontains)
        {
            ...
            string geturl = $"https://back.glsystem.net/api/v1/container/?demo={demo}&page={page}&page_size={page_size}&title__icontains={titletitle__icontains}";
        ...
        public async Task<string> postContainer()
        {
            HttpClient httpClient = new HttpClient();
            ...
            string posturl = $"https://back.glsystem.net/api/v1/container/";
        ...
        public async Task<string> putContainer(int id)
        {
            HttpClient httpClient = new HttpClient();
        ...
        public async Task<string> copyid(int id)
        {
            ...
            string posturl = $"https://back.glsystem.net/api/v1/container/{id}/copy/";
            JsonContent content = JsonContent.Create(this);
            using var response = await httpClient.PostAsync(posturl, content);
            string conetent = await response.Content.ReadAsStringAsync();
            return conetent;
